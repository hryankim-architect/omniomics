...
control; one real knowledge-anchored gain). The discovery validations use TCGA-BRCA; a truly external cohort
is the natural next test. Discovered axes are candidate hypotheses, not causal claims.
